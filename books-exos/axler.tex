...
%------------------------------------------------------------------------ 
\exo{} \begin{itemize}
\item Any $U,I\subset V$ subspaces of $V$ such that $U + I = U$? Yes, $I = \{0\}$ is the "additive identity" subspace.
\item $U+W = \{0\}$? \hilight{... ??}
\end{itemize}
%------------------------------------------------------------------------ 
\exo{}$U_1+W = U_2 + W$ then any point $x= u_1 + w = u_2 + w'$ with $w,w'\in W$. A counterexample in $\mathbb{R}^2$ is \hilight{??}
